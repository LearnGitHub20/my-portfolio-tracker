...
if df is not None and not df.empty:
    ...
    # Use session_state to determine which tab is shown
    tab_list = ["📊 Summary", "🇮🇳 India", "🇺🇸 US", "🇬🇧 London", "🇪🇺 Europe", "⚙️ Settings"]
    ...
    # Render Regional Markets
    market_tabs = {"India": tabs[1], "US": tabs[2], "London": tabs[3], "Europe": tabs[4]}
    for name, tab in market_tabs.items():
        regional_data[name] = render_market(name, tab)
